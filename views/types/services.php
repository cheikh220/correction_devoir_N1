...
<main class="flex-shrink-0">
  <div class="container">
    ...
    <a type="button" href="add_services.php" class=" float-end mb-2 btn btn-primary btn-lg">
      Nouveau
      ...
      <tbody>
        <?php while ($service = $services->fetch(PDO::FETCH_OBJ)) : ?>
          <tr>
            ...
            <td>
              <a href="edit_services.php?id=<?= $service->id ?>" type="button" class="btn btn-primary">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                 Voulez-vous vraimant supprimer ce service ?
                </div>
